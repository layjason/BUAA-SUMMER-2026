...
export const mockData: Record<string, MockResponse> = {
  ...
  'GET /activities/2010': {
    ...
    data: {
      ...
      coverImage: { url: 'https://picsum.photos/800/400?random=101', mediaId: 'img2010' },
      images: [],
      feeAmount: 0,
      capacity: 20,
      registeredCount: 8,
  ...
  'GET /activities/2025': {
    ...
    data: {
      ...
      coverImage: { url: 'https://picsum.photos/800/400?random=202', mediaId: 'img2025' },
      images: [],
      feeAmount: 299.0,
      capacity: 20,
      registeredCount: 20,
  ...
  'POST /activities/media/images': {
    ...
    data: {
      ...
      sizeBytes: 204800,
      usage: 'activityImage',
      url: 'https://picsum.photos/800/400?random=upload',

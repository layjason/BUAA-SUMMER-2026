...
const initialMerchants = [
  {
    ...
    avatar: {
      ...
      sizeBytes: 12450,
      usage: 'avatar',
      signedUrl: MOCK_IMAGES.avatarMerchant,
...
const initialActivities = [
  {
    ...
    coverImage: {
      ...
      sizeBytes: 154000,
      usage: 'activityImage',
      signedUrl: MOCK_IMAGES.coverCamping,
  ...
  },
  {
    ...
    coverImage: {
      ...
      sizeBytes: 110000,
      usage: 'activityImage',
      signedUrl: MOCK_IMAGES.coverBoardgame,
  ...
  },
  {
    ...
    coverImage: {
      ...
      sizeBytes: 82000,
      usage: 'activityImage',
      signedUrl: MOCK_IMAGES.coverKtv,
